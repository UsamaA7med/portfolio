...
const Contact = () => {
  return (
    <section id="contact" className="text-white container  mx-auto px-4 py-32">
      <motion.div
          ...
          >
            <div className="space-y-2">
              ...
              <a
                ...
                className="text-2xl font-semibold transition duration-300 flex items-center gap-2 hover:text-gray-400"
              >
                +201153086221
